    ...
    <>
        <Transition appear show={isOpen} as={Fragment} >
            <Dialog as ={'div'} className='relative z-10' onClose={closeModal}>
                <Transition.Child as={Fragment} enter='ease-out duration-1300' enterFrom='opacity-0 ' enterTo='opacity-100' leave='ease-in duration-200' leaveFrom='opacity-100' leaveTo='opacity-0  '>
                    <div className='fixed bg-opacity-25 inset-0 bg-black '/>
                </Transition.Child>
